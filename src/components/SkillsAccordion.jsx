...
const skills = [
    ...
    },
    {
        ...
        icon: <i className="ri-server-fill text-2xl text-[#3BE698]"></i>,
        content: [
            { section: "Node.js" },
            { section: "Express.js" },
    ...
    },
    {
        ...
        icon: <i className="ri-database-2-fill text-2xl text-[#3BE698]"></i>,
        content: [
            { section: "MongoDB" },
    ...
    },
    {
        ...
        icon: <i className="ri-gitlab-fill text-2xl text-[#3BE698]"></i>,
        content: [
            { section: "Docker" },
            { section: "Kubernetes" },
    ...
    },
    {
        ...
        icon: <i className="ri-tools-fill text-2xl text-[#3BE698]"></i>,
        //
        content: [
            { section: "Vercel" },
            { section: "Render" },
